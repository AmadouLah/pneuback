...
public interface UserRepository extends JpaRepository<User, Long> {
    ...
    long countByEmailAndFailedAttemptsGreaterThanEqual(@Param("email") String email, @Param("maxAttempts") int maxAttempts);
// ===== MÉTHODES SUPPLÉMENTAIRES UTILES =====
    ...
    default boolean isValidPhoneForCountry(String phoneNumber, Country country) {
        if (phoneNumber == null || country == null) return false;
